...
import kotlinx.android.synthetic.main.activity_new_year_greeting2.fl_drawing_view_container
import kotlinx.android.synthetic.main.activity_new_year_greeting2.ib_sharebutton
import java.io.File
    ...
    private inner class BitmapAsyncTask(val mBitmap: Bitmap?) :
        ...
        override fun onPostExecute(result: String) {
            ...
            if(result!!.isNotEmpty()){
                Toast.makeText(this@NewYearGreeting,
        ...
        private fun saveToGallery(): String {
            ...
            var resolver = this@NewYearGreeting.contentResolver
            ...
            if (android.os.Build.VERSION.SDK_INT >= 29) {
                ...
                if (uri != null) {
                    ...
                    this@NewYearGreeting.contentResolver.update(uri, values, null, null)
