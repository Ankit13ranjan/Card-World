...
import kotlinx.android.synthetic.main.activity_marriage_greeting.fl_drawing_view_container
import kotlinx.android.synthetic.main.activity_marriage_greeting.ib_sharebutton
        ...
        private inner class BitmapAsyncTask(val mBitmap: Bitmap?) :
            ...
            override fun onPostExecute(result: String) {
                ...
                if(result!!.isNotEmpty()){
                    Toast.makeText(this@MarriageGreeting,
            ...
            private fun saveToGallery(): String {
                ...
                var resolver = this@MarriageGreeting.contentResolver
                ...
                if (android.os.Build.VERSION.SDK_INT >= 29) {
                    ...
                    if (uri != null) {
                        ...
                        this@MarriageGreeting.contentResolver.update(uri, values, null, null)
